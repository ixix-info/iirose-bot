...
```
如果网络环境差，可以下载或复制[install.sh](https://github.com/ixix-info/iirose-bot/blob/main/install.sh)之后运行
...
#### 3. 下载并运行脚本：
   ...
   ```powershell
   iex (irm https://raw.githubusercontent.com/ixix-info/iirose-bot/main/install.ps1)
   ```

   或者手动保存为 install.ps1 后运行：
